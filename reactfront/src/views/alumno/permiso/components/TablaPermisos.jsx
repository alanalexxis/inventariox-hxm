...
import CardFiltroAlumno from "components/card/CardFiltroAlumno";

const TablaPermisosAlumnos = ({ transparent, onFilterAprobados }) => {
  ...
  const deletePermiso = async (idpermisos) => {
    try {
      ...
      const permisosFiltrados = permisos.filter(
        (permiso) => permiso.nombre === data.alumno.nombre
      );
  ...
  return (
    <Card extra={"w-full pb-10 p-4 h-full"} style={{ marginTop: "50px" }}>
      ...
      <header className="relative flex items-center justify-between">
        ...
        <CardFiltroAlumno onFilterAprobados={handleFilterAprobados} />
      </header>
                ...
                .map((permiso) => (
                  <tr>
                    ...
                    <td className="flex items-center">
                      ...
                      permiso.status === "Rechazado" ? (
                        <Link to={`/alumno/permiso/edit/${permiso.idpermisos}`}>
...
export default TablaPermisosAlumnos;
