...
const CompEditGrupo = () => {
  ...
  const update = async (e) => {
    ...
    if (!idcarreras) {
      ...
      await axios.put(URIgrupo + idgrupos, {
        nomGrupos: grupo,
  ...
  const getBlogById = async () => {
    const res = await axios.get(URIgrupo + idgrupos);
    setGrupo(res.data.nomGrupos);
    setIdcarreras(res.data.idcarreras);
    setIdperiodos(res.data.idperiodos);
    setIdtutores(res.data.idtutors);
  };
