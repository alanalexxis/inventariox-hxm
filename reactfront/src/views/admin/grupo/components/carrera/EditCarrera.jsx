...
const CompEditCarrera = () => {
  ...
  const update = async (e) => {
    ...
    if (!iddirectores) {
      ...
      await axios.put(URI + idcarreras, {
  ...
  const getBlogById = async () => {
    const res = await axios.get(URI + idcarreras);
    setNomCarreras(res.data.nomCarreras);
    setTurno(res.data.turno);
    setIddirectores(res.data.iddirectores);
  };
